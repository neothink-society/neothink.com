...
export const INSL_FAQ = [
  ...
  },
  {
    ...
    answer:
      "No. It is Society-oriented educational content from WordPress, published by the Neothink Institute as public context. Cross-check FAQ and Contact.",
  },
  {
    question: "Where are coaching programs and Neothink University on this site?",
    answer:
      "Use the Programs hub and Neothink University routes linked from this article and from the site footer.",
  },
] as const;
