/**
 * Neothink Mentality lesson 12: Money Love Affair (WordPress post id 4724).
 * Video: https://www.youtube.com/watch?v=CAMx5sC1Fy8
 * @see migration/source/money-love-affair.html (fetch via wp-fetch-page)
 */
export const MONEY_LOVE_AFFAIR_LESSON = {
  number: 12,
  slug: "/money-love-affair",
  title: "Money Love Affair",
  shortTitle: "Money love affair",
  youtubeId: "CAMx5sC1Fy8",
  datePublished: "2026-01-15",
  dateModified: "2026-02-11",
  readTimeMinutes: 9,
  /** ~8:27 spoken runtime on YouTube */
  videoRuntimeMinutes: 8,
} as const;

export const MONEY_LOVE_AFFAIR_TAKEAWAYS = [
...
export const MONEY_LOVE_AFFAIR_OBSESSION = [
...
export const MONEY_LOVE_AFFAIR_LOVE_AFFAIR = [
...
export const MONEY_LOVE_AFFAIR_STEPS = [
  {
    title: "Name the tether",
    body:
  ...
  {
    title: "Separate production from creation",
    body:
...
export const MONEY_LOVE_AFFAIR_FAQ = [
  {
    question: "Does this mean money doesn’t matter?",
    answer:
  ...
  {
    question: "What is “production of existing values” vs “creation of new values”?",
    answer:
  ...
  {
    question: "Is the Elon Musk vs McDonald’s cook comparison literal?",
    answer:
  ...
  {
    question: "How does this connect to prior lessons?",
    answer:
  ...
  {
    question: "What if I don’t know what value to create yet?",
    answer:
