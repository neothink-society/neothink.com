export const HOW_EVERY_INDIVIDUAL_CAN_BE_WEALTHY_FAQ = [
  {
  ...
  },
  {
    ...
    answer:
      "The following mode is a mental virus inherited from the bicameral mentality 3,000 years ago. In this mode, humans follow external authorities instead of thinking independently. We wake up to consciousness through mimicked learned reactions and most people never move beyond that, staying in a state where they follow what they’re told by leaders and authorities.",
  },
  {
    question: "What is Neothink?",
    answer:
      "Neothink is a new mentality that liberates the human race from the following mode. It breaks people free from the need to follow external authorities and allows the vast mind within every person to explode. Neothink brings us a new world with no ruling classes, no followers, and complete freedom to be the person we were meant to be.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A network state is a country built on the internet. It brings together people from all different countries who want to live under the Prime Law with no initiatory force. Over time, as the structure, documents, and population are built, the network state transitions to a physical nation state with territory.",
  },
  {
