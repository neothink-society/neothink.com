  ...
  return (
    <section aria-labelledby="hero-heading" className="relative flex min-h-screen flex-col justify-center px-6 pb-20 pt-[120px] md:px-12">
      <div className="mx-auto w-full max-w-[1160px]">
        <p
          className="nti-reveal mb-8 text-[11px] font-medium uppercase tracking-[0.22em] text-[#8A7030]"
        ...
        <h1
          id="hero-heading"
          className="nti-reveal max-w-[820px] mb-9 font-[family-name:var(--font-cormorant-garamond)] font-light leading-[1.08] tracking-[-0.01em] text-[clamp(48px,6vw,86px)] text-[#0E0E0E]"
