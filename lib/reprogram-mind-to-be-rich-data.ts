/**
 * Neothink Awakening article from WordPress post `reprogram-mind-to-be-rich` (id 5216).
 * Rich Elementor body in `reprogram-mind-to-be-rich-body-html.ts`.
 *
 * @see https://neothink.com/wp-json/wp/v2/posts/5216
 */
...
export const RMTBR_DATES = {
  datePublished: "2026-01-23",
  dateModified: "2026-02-11",
} as const;

export const RMTBR_META_TITLE = "Reprogram Your Mind to Be Rich in One Hour… The Neothink Approach" as const;

export const RMTBR_HEADLINE = "Reprogram Your Mind to Be Rich in One Hour" as const;

export const RMTBR_YOUTUBE_ID = "zw70DiaRR3M" as const;
