export const BUILDING_THE_ENGINE_BEHIND_IMMORTALIS_FAQ = [
  ...
  {
    question: "What happened when publishers rejected Neo-Tech?",
    answer: "In the late 1970s, Warner Publishing and Crown Publishing rejected the Neo-Tech Discovery out of fear. Hamilton’s family turned it into their own publishing business, ultimately selling over three million copies and reaching two million searchers worldwide. Hamilton considers the rejection a blessing in disguise.",
  },
  {
    question: "What is the 10-year plan for land-based Immortalis?",
    answer: "Hamilton envisions Immortalis becoming a physical, land-based country that serves as the medical mecca of the world. Scientists would relocate there to pursue longevity research free from regulatory suppression, creating a brain drain that triggers an economic boom and accelerates the cure for aging.",
  },
] as const;
