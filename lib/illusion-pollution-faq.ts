export const ILLUSION_POLLUTION_FAQ = [
  {
    question: "What is illusion pollution?",
    answer: "Mark Hamilton’s term for the accumulated mental contamination from growing up in a ruling-class cult. It begins in childhood education, continues through media and political conditioning, and causes good people to support policies that damage themselves while enriching the cult leaders.",
  },
  {
  ...
  },
  {
    ...
    answer: "The gap created by illusion pollution that prevents most people from understanding the Immortalis vision. People conditioned by the cult cannot conceive of a civilization under the Prime Law because the illusions trigger panic at the idea of reduced government and individual sovereignty.",
  },
  {
  ...
  },
  {
    ...
    answer: "Hamilton observes that brilliant minds working on government efficiency are unknowingly creating the conditions that make the Immortalis mission viable. By deprogramming the population through structural change and rising prosperity, they are staging the ground for the broader adoption of the Immortalis vision.",
  },
  {
