...
export const metadata = pageMetadata({
  ...
  ogType: "article",
  article: {
    publishedTime: `${SOARING_PRODUCTIVITY_LESSON.datePublished}T12:00:00.000Z`,
    modifiedTime: `${SOARING_PRODUCTIVITY_LESSON.dateModified}T12:00:00.000Z`,
  },
});
...
const videoLd = videoObjectJsonLd({
  ...
  contentUrl: `https://www.youtube.com/watch?v=${SOARING_PRODUCTIVITY_LESSON.youtubeId}`,
  durationMinutes: SOARING_PRODUCTIVITY_LESSON.videoRuntimeMinutes,
