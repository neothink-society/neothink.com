/**
 * Neothink Awakening article from WordPress post `freedom-key-to-unlocking-true-wealth` (id 5327).
 * Rich Elementor body lives in `freedom-key-to-unlocking-true-wealth-body-html.ts`.
 *
 * @see https://neothink.com/wp-json/wp/v2/posts/5327
 */
...
export const FKTUW_HEADLINE = "Freedom Is the Key to Unlocking True Wealth" as const;
...
export const FKTUW_QUICK_ANSWER = {
  kicker: "Quick answer",
