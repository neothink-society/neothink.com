export const VALUE_CREATOR_FAQ = [
  {
    question: "What is the difference between value production and value creation?",
    answer:
      "Production maintains existing systems: executing routines, managing processes, staying within boundaries someone else set. Creation builds something new that did not exist before. The value producer suffers the “burden of life.” The value creator replaces it with exhilaration.",
  },
  {
    question: "Can I become a value creator in my current job?",
    answer:
  ...
  {
    question: "Why do value creators experience work as play?",
    answer:
      "The human mind is designed to create. When you fulfill that design, engagement happens naturally: total absorption, euphoria, guilt-free happiness. Hamilton is not being metaphorical. He is describing the same state children experience in play, applied to adult creation.",
  },
  {
    question: 'What is the "burden of life"?',
    answer:
  ...
  {
    question: 'What does Hamilton mean by the "God-Man"?',
    answer:
