 ...
 */
export const UNLOCK_YOUR_GENIUS_LESSON = {
  number: 7,
  slug: "/unlock-your-genius",
  title: "Unlock Your Genius",
  shortTitle: "Unlock your genius",
  youtubeId: "6RQq_gzAKU8",
...
export const UNLOCK_YOUR_GENIUS_PROCESS_STEPS = [
  ...
  },
  {
    ...
    body: "Widen view of the workplace so integration becomes possible; this series builds that habit step by step.",
  },
  {
    title: "Take baby steps",
    body: "A more efficient task or procedure you introduce is framed as a first move into integrated thinking and creation.",
  },
  {
  ...
  },
  {
    ...
    body: "Let integrated thinking touch money, relationships, and emotion as far as your context allows; the Neothink mentality names that unified lift.",
  },
] as const;

export const UNLOCK_YOUR_GENIUS_FAQ = [
  {
