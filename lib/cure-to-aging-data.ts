 ...
 */
export const CURE_TO_AGING_LESSON = {
  number: 10,
  slug: "/cure-to-aging",
  title: "Cure to Aging",
  shortTitle: "Cure to aging",
  youtubeId: "vnLK2BAN3Lw",
...
/** External site referenced in the video (Billionaire Club / open letter). */
export const CURE2AGING_URL = "https://cure2aging.com" as const;

export const CURE_TO_AGING_TAKEAWAYS = [
...
export const CURE_TO_AGING_PATH_FLOW = [
  { step: 1, label: "Spread the Neothink Mentality" },
  { step: 2, label: "Create massive demand for life" },
  { step: 3, label: "Money flows into R&D" },
  { step: 4, label: "Cure aging" },
] as const;

export const CURE_TO_AGING_DEMAND_LIST = [
...
export const CURE_TO_AGING_SUPPLY_LIST = [
...
export const CURE_TO_AGING_STEPS = [
  {
...
export const CURE_TO_AGING_FAQ = [
  {
  ...
  {
    question: "What can I do now while waiting for the cure?",
    answer:
