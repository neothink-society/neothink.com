/**
 * Neothink Philosophy post `libertarians-next-big-possibility` (id 6215).
 * Body HTML: `libertarians-next-big-possibility-body-html.ts`.
 *
 * @see https://neothink.com/wp-json/wp/v2/posts/6215
 */

export const LIBERTARIANS_NEXT_BIG_POSSIBILITY_PATH = "/libertarians-next-big-possibility" as const;

export const LIBERTARIANS_NEXT_BIG_POSSIBILITY_DATES = {
