export const THE_YEAR_CAPITALISM_SETS_THE_WORLD_FREE_FAQ = [
  ...
  },
  {
    ...
    answer: "Government becomes a protection service funded by a voluntary 10% tithe. Citizens pay willingly because the system produces so much wealth, health, and safety that maintaining it is an obvious self-interest calculation. The competitive nature of multiple protection services drives the best values to the top.",
  },
  {
    question: "Why haven’t healthcare costs dropped like computing costs?",
    answer: "Because government succeeded in regulating healthcare where it failed to regulate computing. The computer revolution moved too fast for bureaucracies to control. Healthcare, energy, and other industries are held back by politicized regulations and legislation. Hamilton’s father’s cancer cure at DuPont was killed by cost-prohibitive government regulations 50 years ago.",
  },
  {
