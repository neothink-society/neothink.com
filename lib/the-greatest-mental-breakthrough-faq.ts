export const GMB_FAQ = [
  {
    question: "What is the difference between removing the negative and positive thinking?",
    answer:
  ...
  {
    question: "How do I identify which negatives to remove first?",
    answer:
  ...
  {
    question: "Can the division of essence work in traditional corporate environments?",
    answer:
  ...
  {
    question: "What is the relationship between Neothink and Julian Jaynes' bicameral theory?",
    answer:
  ...
  {
    question: "Why do you say negatives are finite while positives are infinite?",
    answer:
  ...
  {
    question: "How does removing the negative relate to the goal of human longevity?",
    answer:
