/**
 * Neothink Philosophy post `the-greatest-mental-breakthrough` (id 4963).
 * Body HTML: `the-greatest-mental-breakthrough-body-html.ts`.
 *
 * @see https://neothink.com/wp-json/wp/v2/posts/4963
 */

export const GMB_PATH = "/the-greatest-mental-breakthrough" as const;

export const GMB_DATES = {
  datePublished: "2025-10-21",
  dateModified: "2026-02-10",
} as const;

export const GMB_META_TITLE =
  "The Greatest Mental Breakthrough: Why Removing the Negative Outperforms Adding the Positive" as const;

export const GMB_HEADLINE =
  "The Greatest Mental Breakthrough: Why Removing the Negative Outperforms Adding the Positive" as const;

export const GMB_YOUTUBE_ID = "d3HfDaeyi7A" as const;

export const GMB_INTRO_HTML =
