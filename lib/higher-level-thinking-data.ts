 ...
 */
export const HIGHER_LEVEL_THINKING_LESSON = {
  number: 5,
  slug: "/higher-level-thinking",
  title: "Higher Level Thinking",
  shortTitle: "Higher level thinking",
  youtubeId: "EVauhNelWOQ",
...
export const HIGHER_LEVEL_THINKING_DOWN_HERE = [
...
export const HIGHER_LEVEL_THINKING_UP_HERE = [
...
export const HIGHER_LEVEL_THINKING_RISING_STEPS = [
  {
...
export const HIGHER_LEVEL_THINKING_FAQ = [
  {
  ...
  {
    question: "Can I practice higher level thinking if I work alone or remotely?",
    answer:
  ...
  {
    question: "What is the difference between integrated thinking and just being observant?",
    answer:
