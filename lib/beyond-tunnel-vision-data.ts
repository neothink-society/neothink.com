...
export const BEYOND_TUNNEL_VISION_LESSON = {
  number: 3,
  slug: "/beyond-tunnel-vision",
  title: "Beyond Tunnel Vision",
  shortTitle: "Beyond tunnel vision",
  youtubeId: "JjCUJraMhhA",
...
export const BEYOND_TUNNEL_VISION_TAKEAWAYS = [
...
export const BEYOND_TUNNEL_VISION_TUNNEL_VISION = [
...
export const BEYOND_TUNNEL_VISION_CURIOUS = [
...
export const BEYOND_TUNNEL_VISION_PROJECT_STEPS = [
  {
    title: "Commit to two weeks",
    body: "Not a one-day experiment. Mark a start date and hold the full period so tunnel-vision habits can loosen.",
  },
  {
  ...
  },
  {
    ...
    body: "Study customers, process, and flow. Ask what creates value and what creates friction, from an owner-wide lens.",
  },
  {
    title: "Ask coworkers about their jobs",
    body: "Approach sincerely; if asked why, express real appreciation for their contribution. Most people respond well.",
  },
  {
...
export const BEYOND_TUNNEL_VISION_FAQ = [
  {
    question: "What if my job doesn’t allow time to observe the business?",
    answer:
  ...
  {
    question: "Why specifically two weeks?",
    answer:
  ...
  {
    question: "What if coworkers think it’s strange that I’m asking about their jobs?",
    answer:
  ...
  {
    question: "I work remotely. Can I still practice Project Curiosity?",
    answer:
  ...
  {
    question: "What’s the difference between curiosity and being nosy?",
    answer:
