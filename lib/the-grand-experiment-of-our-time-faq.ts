export const THE_GRAND_EXPERIMENT_OF_OUR_TIME_FAQ = [
  {
    question: "What is the grand experiment Hamilton refers to?",
    answer:
  ...
  {
    question: "How is the Prime Law different from the US Constitution?",
    answer:
  ...
  {
    question: "What do Hong Kong, Singapore, Dubai, and Próspera have in common?",
    answer:
  ...
  {
    question: "Why does Hamilton call Immortalis the medical mecca of the world?",
    answer:
  ...
  {
    question: "Who are the libertarian thinkers Hamilton references?",
    answer:
  ...
  {
    question: "What is the connection to the Mont Pelerin Society?",
    answer:
